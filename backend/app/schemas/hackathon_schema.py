...
class HackathonCreate(BaseModel):
    ...
    college_name: str = Field(..., description="Name of the hosting college")
    college_address: str = Field(..., description="Full address of the college")
    google_map_link: str = Field(..., description="Google Maps URL for the location")
    is_paid: bool = Field(False, description="Whether the event is paid")
    entry_fee: Optional[float] = Field(0.0, description="Entry fee for the event")
...
class HackathonResponse(BaseModel):
    ...
    college_name: Optional[str] = Field(None, description="Name of the hosting college")
    college_address: Optional[str] = Field(None, description="Full address of the college")
    google_map_link: Optional[str] = Field(None, description="Google Maps URL for the location")
    is_paid: bool = Field(False, description="Whether the event is paid")
    entry_fee: Optional[float] = Field(0.0, description="Entry fee for the event")
