...
def create_hackathon(
    ...
    payment_qr_image: Optional[UploadFile],
    ...
    upi_qr_image_url = None
    if is_paid and payment_qr_image:
...
def get_college_hackathons(college_id: str):
    ...
    for hackathon in hackathons:
        ...
        pending_verifications = db.registrations.count_documents({
        ...
        hackathon_data["pending_verifications"] = pending_verifications
...
def get_hackathon_registrations(hackathon_id: str, college_id: str):
    ...
    for reg in registrations:
        ...
        result.append({
            ...
            "payment_proof_url": reg.get("payment_proof_url"),
