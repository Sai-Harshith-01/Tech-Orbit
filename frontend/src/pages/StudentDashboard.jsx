   ...
   <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 animate-zoomIn">
    ...
    <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
     ...
     <div className="flex gap-4">
      <Link to="/community" className="btn-premium flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 shadow-indigo-500/20">
       <Users className="w-5 h-5" /> Student Community
      </Link>
