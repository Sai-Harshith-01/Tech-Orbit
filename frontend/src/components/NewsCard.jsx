const NewsCard = ({ news, index }) => {
	...
	// Use index if provided for variety, fallback to title length. Rotate through 10 images.
	const imgIdx = (index !== undefined ? index : (news.title ? news.title.length : 0)) % 10 + 1;
	// The user has changed naming to 'imageX.jpeg'. Note: image5.jpeg is currently missing.
	const finalIdx = imgIdx === 5 ? 1 : imgIdx;
	const defaultImg = `/news-default/image${finalIdx}.jpeg`;
