    ...
    try {
      ...
      if (lowerInput.includes('hackathon') || lowerInput.includes('event')) {
        ...
        if (lowerInput.includes('my') || lowerInput.includes('register')) {
          ...
          return "You haven't joined any events yet! Check the 'Event' tab to start your first mission.";
        }
      ...
      if (lowerInput.includes('how') || lowerInput.includes('help') || lowerInput.includes('where') || lowerInput.includes('rule') || lowerInput.includes('guide')) {
        ...
        if (lowerInput.includes('register')) {
          return "To join an event, head over to the **Event** page, pick an event that excites you, and click **'Join'**. I'll generate your unique code instantly!";
        }
        ...
        return "I'm Orbiton, your TechOrbit guide! I can help you find news, track event deadlines, or manage your articles. What's on your mind?";
      }
      ...
      if (lowerInput.includes('hello') || lowerInput.includes('hi')) {
        return "Hello! I'm Orbiton, your TechOrbit navigator. Ready for liftoff? Ask me about news, events, or how to use the platform!";
      }

      return "I'm here to serve the TechOrbit mission! Ask me about tech news, upcoming events, article summaries, or platform help.";
    } catch (error) {
      console.error(error);
