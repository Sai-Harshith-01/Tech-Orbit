    ...
    <div className="premium-card flex flex-col h-full group">
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <Link to={`/article/${article.id}`}>
          <h3 className="text-xl font-bold text-slate-900 mb-3 line-clamp-2 leading-tight hover:text-brand-600 transition-colors cursor-pointer">
            {article.title}
          </h3>
        </Link>
        ...
        <Link 
          ...
          className="inline-flex items-center gap-2 text-brand-600 font-bold text-xs uppercase tracking-widest mb-6 hover:gap-3 transition-all"
        >
